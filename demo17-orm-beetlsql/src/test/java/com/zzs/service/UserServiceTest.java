...
import com.zzs.Demo17OrmBeetlsqlApplicationTests;
...
@Slf4j
public class UserServiceTest extends Demo17OrmBeetlsqlApplicationTests {
    ...
    public void saveUser() {
        ...
        User user = User.builder().name("testSave3").password(SecureUtil.md5("123456" + salt)).salt(salt).email("testSave3@zzs.com").phoneNumber("17300000003").status(1).lastLoginTime(new DateTime()).createTime(new DateTime()).lastUpdateTime(new DateTime()).build();
